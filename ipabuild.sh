...
mkdir Payload
cp -r Chicken\ Butt.app Payload/Chicken\ Butt.app
strip Payload/Chicken\ Butt.app/Chicken\ Butt
zip -vr Chicken\ Butt.ipa Payload
rm -rf Chicken\ Butt.app
rm -rf Payload
